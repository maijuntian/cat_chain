...
/**
 * Created by maijuntian on 2018/4/19.
 */
class SharedPreferencesUtils {
    ...
    companion object {
        ...
        private val sysPref = MyApplication.instance?.getSharedPreferences(SYSTEM_DATA, Context.MODE_PRIVATE)
        private val userPref = MyApplication.instance?.getSharedPreferences(USER_PRE, Context.MODE_PRIVATE)
