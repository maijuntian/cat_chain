 ...
 */
public class XLineChartLandView extends View {
    ...
    public XLineChartLandView(Context context) {
        super(context);
        initView();
    }

    public XLineChartLandView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public XLineChartLandView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
