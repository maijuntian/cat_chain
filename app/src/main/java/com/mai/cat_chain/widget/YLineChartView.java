 ...
 */
public class YLineChartView extends View {
    ...
    public YLineChartView(Context context) {
        super(context);
        initView();
    }

    public YLineChartView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public YLineChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
